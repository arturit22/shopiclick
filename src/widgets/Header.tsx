...
export function Header() {
  ...
  const searchValue = useSelector(
    (state: RootState) => state.catalog.searchValue
  )
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/60 backdrop-blur border-b p-4">
      <div className="container mx-auto flex flex-col gap-4 px-4 py-4 md:flex-row md:items-center md:justify-between">
        <Link
          to="/"
          className="text-2xl font-extrabold tracking-tight text-gray-900 transition hover:opactity-80"
        >
          ShopiClick
        </Link>
        ...
        <div className="relative w-full md:max-w-xl">
          ...
          <input
            ...
            className="w-full rounded-full border border-gray-300 bg-white py-3 pl-11 pr-4 text-sm outline-none transition focus:border-black"
          />
        </div>
        ...
        <div className="relative" ref={miniCartRef}>
          <button
            ...
            className="relative inline-flex items-center gap-2 self-start rounded-full border border-gray-300 px-4 py-2 font-medium text-gray-900 transition hover:bg-gray-100 md:self-auto"
          >
